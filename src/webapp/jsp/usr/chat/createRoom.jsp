...
<div class="m-auto block p-6 rounded-lg shadow-lg bg-white max-w-md">
  <form method="POST" onsubmit="ChatRoomSave__submitForm(this); return false;">
    <div class="form-group mb-6">
      <input name ="title" type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput7"
             placeholder="채팅방 이름을 입력해주세요">
    </div>
    <div class="form-group mb-6">
      <input name="writer" type="text" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none" id="exampleInput8"
             placeholder="채팅방 소유자를 입력해주세요.">
    </div>
    <div class="form-group mb-6">
      <textarea name="body"
